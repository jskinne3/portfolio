...
The app dispatches ICE agents to hit "groups of pre-defined aliens specifically targeted by Leadership for action." It allows the administration to order up a goon squad wherever they want, at the touch of a button. Like Uber for authoritarians. Let's call it repression as a service.
...
At the time of the GSA DOGE presentation I feared that [the goal of this AI strategy](https://bsky.app/profile/skiles.blue/post/3llxflpllgk2r) was to make a continuous pushbutton repression system patterned on the metaphor of Palantir from LotR.
